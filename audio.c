...
void audio_init()
{
    ...
    sample_clear = al_load_sample("resources/sounds/clear.ogg");
    must_init(sample_clear, "clear sound");
    sample_wrong_play = al_load_sample("resources/sounds/wrong_move.ogg");
    must_init(sample_wrong_play, "wrong play sound");
    sample_mult[0] = al_load_sample("resources/sounds/multi_2.ogg");
    must_init(sample_mult[0], "mult[0] sound");
    sample_mult[1] = al_load_sample("resources/sounds/multi_3.ogg");
    must_init(sample_mult[1], "mult[1] sound");
    sample_mult[2] = al_load_sample("resources/sounds/multi_4.ogg");
    must_init(sample_mult[2], "mult[2] sound");
    sample_mult[3] = al_load_sample("resources/sounds/multi_5.ogg");
    must_init(sample_mult[3], "mult[3] sound");
    sample_mult[4] = al_load_sample("resources/sounds/multi_6.ogg");
